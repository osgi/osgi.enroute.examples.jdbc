...
public class AddressDaoImpl implements AddressDao {
	...
	void activate(Map<String, Object> props) throws SQLException {
		...
		transactionControl.supports( () -> connection.prepareStatement(PersonAddressTable.INIT).execute());
	}
	...
	public void save(Long personId, AddressDTO data) {
		...
		boolean isThereACoordination = coordinator.addParticipant(addressSaveParticipant);
	...
	public void update(Long personId, AddressDTO data) {
		...
		boolean isThereACoordination = coordinator.addParticipant(addressUpdateParticipant);
	...
	protected void addAddressesToCoordinator(Class<?> keyClass, AddressDTO addressDTO) {
		...
		List<AddressDTO> addressDtos = (List<AddressDTO>) cordVars.computeIfAbsent(keyClass,
				k -> new ArrayList<AddressDTO>());
